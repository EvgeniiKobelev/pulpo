...
pub struct AsterdexFutures {
    config: ExchangeConfig,
    rest: rest::AsterdexFuturesRest,
}

impl AsterdexFutures {
    pub fn new(config: ExchangeConfig) -> Self {
        let rest = rest::AsterdexFuturesRest::new(&config);
        Self { config, rest }
    }
...
#[async_trait]
impl Exchange for AsterdexFutures {
    fn id(&self) -> ExchangeId {
        ExchangeId::AsterdexFutures
    }
...
#[async_trait]
impl FuturesExchange for AsterdexFutures {
