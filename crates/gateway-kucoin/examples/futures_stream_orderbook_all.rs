//! Subscribe to order book updates for ALL KuCoin Futures perpetual symbols.
//!
...
//!
//! Run: cargo run -p gateway-kucoin --example futures_stream_orderbook_all
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("Fetched {} total symbols from KuCoin Futures", all_symbols.len());
