//! Subscribe to order book updates for ALL BloFin perpetual symbols.
//!
...
//!
//! Run: cargo run -p gateway-blofin --example stream_orderbook_all
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("Fetched {} total symbols from BloFin Futures", all_symbols.len());
