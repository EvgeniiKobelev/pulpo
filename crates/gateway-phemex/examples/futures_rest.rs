...
async fn main() -> anyhow::Result<()> {
    ...
    println!("=== Phemex Futures Exchange Info ===");
    ...
    println!("  Open interest       : {}", oi.open_interest);
