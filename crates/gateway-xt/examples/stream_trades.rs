//! WebSocket trades streaming example for XT Futures.
//!
//! Subscribes to a single symbol trade stream and prints each trade.
//!
//! Run: cargo run -p gateway-xt --example stream_trades
//! Custom symbol: cargo run -p gateway-xt --example stream_trades -- ETH/USDT
...
async fn main() -> anyhow::Result<()> {
    ...
    println!(
        "Subscribing to {}/{} trades on XT Futures...\n",
