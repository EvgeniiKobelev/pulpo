//! WebSocket order book streaming example for XT Futures.
//!
//! Subscribes to a single symbol orderbook stream and prints top-5 bids/asks.
//!
//! Run: cargo run -p gateway-xt --example stream_orderbook
//! Custom symbol: cargo run -p gateway-xt --example stream_orderbook -- ETH/USDT
...
async fn main() -> anyhow::Result<()> {
    ...
    println!(
        "Subscribing to {}/{} order book on XT Futures...\n",
