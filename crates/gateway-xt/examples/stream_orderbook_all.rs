//! Subscribe to order book updates for ALL XT perpetual symbols.
//!
...
//!
//! Run: cargo run -p gateway-xt --example stream_orderbook_all
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("Fetched {} total symbols from XT Futures", all_symbols.len());
