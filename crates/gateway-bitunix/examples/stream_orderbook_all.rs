//! Subscribe to order book updates for ALL Bitunix perpetual symbols.
//!
...
//!
//! Run: cargo run -p gateway-bitunix --example stream_orderbook_all
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("Fetched {} total symbols from Bitunix Futures", all_symbols.len());
